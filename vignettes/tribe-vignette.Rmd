---
title: 'Play with the tribe of attributes in R'
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Play with the tribe of attributes in R}
...
Each verb has its standard evaluation version; for instance `take_` is the standard evaluation version of `take`: 
